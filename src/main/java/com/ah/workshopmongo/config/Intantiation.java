package com.ah.workshopmongo.config;
...
import com.ah.workshopmongo.dto.AuthorDTO;
import com.ah.workshopmongo.dto.CommentDTO;
...
public class Intantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// precisa ser antes: por causa dos DTO's
		...
		// associando os posts aos comentários
